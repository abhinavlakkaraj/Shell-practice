...
then
    ...
    echo -e " Nothing to do ... $Y Mysql is Installed $N " | tee -a $LOG_FILE
fi
...
then
    ...
    echo -e "Nothing to do ... $Y Python3 is Installed $N " | tee -a $LOG_FILE
fi
...
then
    ...
    echo -e "Nothing to do ... $Y nginx is Installed $N " | tee -a $LOG_FILE
fi    
